...
const Header = () => {
  ...
  const menuItems = [
    ...
    { name: 'About', href: '#about' },
    {
      ...
      href: '#services',
      dropdown: [
        { name: 'UI/UX Design', href: '#uiux', icon: '🎨' },
        { name: 'Shopify Development', href: '#shopify', icon: '🛍️' },
        { name: 'WordPress Solutions', href: '#wordpress', icon: '📝' },
        { name: 'Web Development', href: '#webdev', icon: '💻' }
      ]
    },
    { name: 'Projects', href: '#projects' },
    {
      ...
      href: '#industries',
      dropdown: [
        { name: 'Clothing & Fashion', href: '#clothing', icon: '👔' },
        { name: 'Food & Beverage', href: '#food', icon: '🍕' },
        { name: 'Metal & Manufacturing', href: '#metal', icon: '⚙️' },
